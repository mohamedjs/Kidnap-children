      ...
      <div class="dashboard-profile-content">
        <div class="row">
          ...
          <div class="col-lg-12" style="margin-top:10px">
            <h4 class="text-center">Match Posts Result</h4>
            <ul class="list_ofPosts list-unstyled">
              <li v-for="(post,key) in result_posts" :key="key">
                  <div class="post">
                    <div class="photo-box-slider swiper-container">
                      <carousel :dots="false"  :nav="false" :items="1" class="swiper-wrapper">
                        <vue-load-image v-for="post_image in post.images" :key="post_image.key">
          ...
          <div class="col-lg-12" style="margin-top:10px">
            ...
            <div id="pano" style="width: 100%;height: 300px;position: relative;overflow: hidden;">
            </div>
          </div>
        </div>
      </div>
    ...
    export default {
      components: { carousel , 'vue-load-image': VueLoadImage },
       ...
       methods: {
         ...
         initMap() {
           var _this = this
           console.log(this.inner_post.lat,this.inner_post.lng);
           var myLatlng = new google.maps.LatLng(this.inner_post.lat,this.inner_post.lng);
             var mapOptions = {
               zoom: 4,
               center: myLatlng
             }
             this.map = new google.maps.Map(document.getElementById("map"), mapOptions);
              this.marker = new google.maps.Marker({
                 ...
                 map: this.map ,
                 //draggable:true,
                 //icon: 'https://www.shareicon.net/data/48x48/2015/10/03/111522_top_512x512.png',
             });
             ...
             var panorama = new google.maps.StreetViewPanorama(
              ...
              $.get(this.base_url+'/address'+'/'+this.inner_post.lat+'/'+this.inner_post.lng+'/'+'en',function(data){
       ...
       mounted() {
         console.log(this.results);
            this.posts.push(this.inner_post)
            this.result_posts = this.results
            console.log(this.result_posts);
            this.initMap()
        }
    }
</script>
